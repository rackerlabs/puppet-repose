...
class repose::filter::container (
  ...
  $app_name                             = undef,
  $artifact_directory                   = $repose::artifact_directory,
  $artifact_directory_check_interval    = 60000,
  $client_request_logging               = undef,
  $content_body_read_limit              = undef,
  $deployment_directory                 = $repose::deployment_directory,
  $deployment_directory_auto_clean      = true,
  $jmx_reset_time                       = undef,
  $log_access_facility                  = $repose::log_access_facility,
  $log_access_app_name                  = $repose::log_access_app_name,
  $log_access_local                     = $repose::log_access_local,
  $log_access_local_name                = $repose::log_access_local_name,
  $log_access_syslog                    = $repose::log_access_syslog,
  $log_dir                              = $repose::logdir,
  $log_herp_app_name                    = $repose::log_herp_app_name,
  $log_herp_facility                    = $repose::log_herp_facility,
  $log_herp_flume                       = $repose::log_herp_flume,
  $log_herp_syslog                      = $repose::log_herp_syslog,
  $log_herp_syslog_postfilter           = $repose::log_herp_syslog_postfilter,
  $log_herp_syslog_prefilter            = $repose::log_herp_syslog_prefilter,
  $log_log4j2_default_loggers           = $repose::log_log4j2_default_loggers,
  $log_log4j2_optional_loggers          = $repose::log_log4j2_optional_loggers,
  $log_log4j2_intrafilter_trace_loggers = $repose::log_log4j2_intrafilter_trace_loggers,
  $log_intrafilter_trace                = $repose::log_intrafilter_trace,
  $log_level                            = $repose::log_level,
  $log_local_policy                     = $repose::log_local_policy,
  $log_local_size                       = $repose::log_local_size,
  $log_local_rotation_count             = $repose::log_local_rotation_count,
  $log_repose_facility                  = $repose::log_repose_facility,
  $log_file_perm                        = $repose::log_file_perm,
  $log_use_log4j2                       = false,
  $logging_configuration                = $repose::logging_configuration,
  $ssl_enabled                          = false,
  ...
  $syslog_server                        = undef,
  $syslog_port                          = $repose::syslog_port,
  $syslog_protocol                      = $repose::syslog_protocol,
  $via                                  = undef,
  $via_header                           = {},
  $flume_host                           = $repose::flume_host,
  $flume_port                           = $repose::flume_port,
